...
<body data-spy="scroll" data-offset="0" data-target="#navigation">
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<?php echo e(url('/order_page')); ?>">order</a></li>
                    <!-- <li><a href="#contact" class="smoothScroll">Contact</a></li> -->
                    {{-- <li><a href="">Appo264.59251308462intment</a></li> --}}
                </ul>
    ...
    <section id="contact" name="contact">
        <div class="container">
            <h3 style="color: black; text-align:center"><b>payment </b></h3>
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="container">
                        ...
                        <hr>
                        <?php 
                        $data= DB::table('orders')->select('*')->orderBy('id', 'asc')->get();
                 foreach ($data as  $value1) {
                     # code...
                 }
                 
             //    print_r($value1->price); ?>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div id="q21" class="q full_width">
                                        ...
                                        <button type="button" class="btn btn-primary btn-block"><a href="/payment_gateway"> <H2 style="color: #FFFFFF"> TOTAL PAY: $<?php echo e($value1->price) ?></H2></a></button>
                                    ...
                                    <article class="card-body">
                                        <form method="post" action="<?php echo e(url('/payment')); ?>" id="appointmentform" role="form" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <img src="la-assets/img/cardlogo.png">
                                                            </div>
                                                    <div class="form-group col-md-6">
                                                        <label>cv No:</label>
                                                ...
                                                <input type="text" class="form-control" name="order" placeholder="card name" >
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <input type="hidden" class="form-control" name="pay" value="<?php echo e($value1->price) ?>">
                                            ...
                                            <div class="form-group col-md-12">
                                                <label>order</label>
                                                <input type="text" class="form-control" placeholder="Please enter order" name="order">
