        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<?php echo e(url('/payment_gateway')); ?>" class="smoothScroll">payment</a></li>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <article class="card-body">
                                        <form method="post" action="<?php echo e(url('/order')); ?>" id="appointmentform" role="form" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="inputState" class="form-control" name="pickup">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>select Drop Up city</label>
                                                    <select id="inputState" class="form-control" name="dropup">
                                                        <option> Select City</option>
                                                        <?php foreach($cities as $value): ?>
                                                        <option value="<?php echo e($value->name); ?>"><?php echo e($value->name); ?></option>
