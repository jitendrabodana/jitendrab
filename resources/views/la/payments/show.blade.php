	...
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $payment->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Payments", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/payments/'.$payment->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Payments", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.payments.destroy', $payment->id], 'method' => 'delete', 'style'=>'display:inline']) }}
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'card')
						@la_display($module, 'cv')
						@la_display($module, 'order')
						@la_display($module, 'pay')
						@la_display($module, 'create_date')
					</div>
				</div>
			</div>
		</div>
